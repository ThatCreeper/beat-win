...
public static class GUI
{
    ...
    public static void Text(string text, int x, int y, bool italic, bool bold, bool underline, bool syntax = false)
    {
        ...
        if (underline)
        {
            Raylib.DrawRectangle(x, y + size, TextWidth(text), Point(1), Foreground);
        }
